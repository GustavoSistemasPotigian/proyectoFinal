 ...
 * @author usuario
 */
public class InterfazCerradosPBI extends javax.swing.JFrame {
    ...
    private String UID;
    public InterfazCerradosPBI(String userId) {
...
/* private void loadCmbMotivo(){
    ...
    private void btnSalirConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalirConsultaActionPerformed
        InterfazCerradosPBI.this.dispose();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            else
            {
                ...
                tipo=(String)modelo.getValueAt(filasel,1);
    ...
    void CargarTablaPlanes(String valor){
      ...
      //  pMotivo=(String) cmbMotivo.getSelectedItem();
       ...
       // valor="Javier";
        ...
        String [] titulos= {"IdCierre","Nro de Plan","Tipo","IDProveedor","FechaCierre", "IDComprador","ImporteDescuento","CuotaNro","CantCuotas" };
       ...
       ///ingresamos la consulta
        sSQL="select pl.id_cierre as idCierre, pl.id_plan_descuento as nroPlan, pl.tipo_plan as Tipo,pl.idProveedor as IdProveedor, "+
             " pl.fecha_cierre as Fecha, pl.importe_descuento as importe, pr.Usuario_idUsuario as IdCobrador, pl.cuota_nro as CuotaNro, pl.cant_cuotas as cantCuotas "+ 
             " from cierre as pl "+ 
        ...
        try 
        {
            ...
            while (rs.next())
            {
                ...
                registro[5]=rs.getString("IdCobrador");
                registro[6]=rs.getString("importe");
                registro[7]=rs.getString("CuotaNro");
                registro[8]=rs.getString("cantCuotas");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazCerradosPBI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new InterfazCerradosPBI(userId).setVisible(true);
            }
        });
    }
