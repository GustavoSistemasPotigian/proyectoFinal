...
public class ConsultaPlanes extends javax.swing.JFrame {
    ...
    private String UID;
    public ConsultaPlanes(String userId) {
...
//METODOS DE LOS BOTONES
    ...
    void CargarTablaPlanes(String valor){
       ...
       // valor="Javier";
        ...
        String [] titulos= {"Nro de Plan","ID","Proveedor","Importe","Fecha Alta","MotivoSNC","Desde","Hasta","M_Cancelacion","M_Impacto","Canal","Estado", "Comprador" };
       ...
       ///ingresamos la consulta
        sSQL="select pl.idPlan_descuento as Plan_Nro, pl.Proveedor_idProveedor as id ,pr.razon_social as Proveedor, "+
             "pl.fechaActual as Fecha,TRUNCATE (pl.importe, 2) as Importe, ti.descripcion_iva as IVA, "+ 
             "mot.descripcion as MotivoSNC, pl.fecha_devengamiento_desde as Desde, "+
             "pl.fecha_devengamiento_hasta as hasta, pl.estado as Estado, pl.obs_comprador, "+
        ...
        try 
        {
            ...
            while (rs.next())
            {
                ...
                registro[8]=rs.getString("M_Cancelacion");
                registro[9]=rs.getString("M_Impacto");
                registro [10]=rs.getString("Canal");
    ...
    public static void main(String args[]) {
       ...
       java.awt.EventQueue.invokeLater(new Runnable()  {
            private String userId;
            public void run(){
            new ConsultaPlanes(userId).setVisible(true);
            }
            });
