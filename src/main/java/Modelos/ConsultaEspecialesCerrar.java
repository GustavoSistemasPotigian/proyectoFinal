 ...
 * @author usuario
 */
public class ConsultaEspecialesCerrar extends javax.swing.JFrame {
    ...
    private String UID;
    public ConsultaEspecialesCerrar() {
        initComponents();
    ...
    private void btnSalirConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalirConsultaActionPerformed
        ConsultaEspecialesCerrar.this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaEspecialesCerrar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaEspecialesCerrar().setVisible(true);
            }
        });
    }
