 ...
 * @author usuario
 */
public class ListadoDeInactivos extends javax.swing.JFrame {
    ...
    private String UID;
    public ListadoDeInactivos(String userId) {
...
/* private void loadCmbMotivo(){
    ...
    private void btnSalirConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalirConsultaActionPerformed
        ListadoDeInactivos.this.dispose();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        chooser.setSelectedFile(new File("planes_inactivos.xls"));
        if (chooser.showSaveDialog(this) == JFileChooser.APPROVE_OPTION)
        {
            ...
            try
            {
                ExcelUtils.exportToExcel(dest, headers, content, "Planes Inactivos");
    ...
    void CargarTablaPlanes(String valor){
      ...
      //  pMotivo=(String) cmbMotivo.getSelectedItem();
       ...
       // valor="Javier";
        ...
        String [] titulos= {"Nro de Plan","Tipo","Proveedor","Fecha Alta", "Comprador","Descripcion","Situacion" };
        ...
        Connection cn= mysql.Conectar();
        String vPlan="";
        String sqlCond="where pl.situacion='INACTIVO' ";
       ...
       ///ingresamos la consulta
        sSQL="select pl.idPlan_descuento as Plan_Nro, pl.tipo_plan as Tipo,pr.razon_social as Proveedor, "+
             ...
             " pl.descuento_descripcion as Descripcion " +
        ...
        try 
        {
            ...
            while (rs.next())
            {
                ...
                registro[4]=rs.getString("Comprador");
                registro[5]=rs.getString("Descripcion");
                registro[6]=rs.getString("Situacion");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListadoDeInactivos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new ListadoDeInactivos(userId).setVisible(true);
            }
        });
    }
